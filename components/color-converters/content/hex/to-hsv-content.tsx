  ...
  return (
    <Container as="section" className="prose pb-12 dark:prose-invert md:pb-24">
      ...
      <p>
        ...
        <a href="https://www.cmyktopantone.com/color-models/hex?ref=rgbtopantone.com">
          HEX color model
        </a>
        , represented by a six-character code, is widely used in web design for defining colors in a
        concise manner. Meanwhile, the HSV (Hue, Saturation, Value) model is often preferred by
        designers for its intuitive approach to describing colors based on their visual properties.
      </p>
      <p>
