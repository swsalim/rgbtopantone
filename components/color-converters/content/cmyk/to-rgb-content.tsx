  ...
  return (
    <Container as="section" className="prose pb-12 dark:prose-invert md:pb-24">
      ...
      <p>
        ...
        The{' '}
        <a href="https://www.cmyktopantone.com/color-models/cmyk?ref=rgbtopantone.com">
          CMYK color model
        </a>
        , primarily used in printing, represents Cyan, Magenta, Yellow, and Key (Black) inks.
        Meanwhile, the{' '}
        <a href="https://www.cmyktopantone.com/color-models/rgb?ref=rgbtopantone.com">
          RGB color model
        </a>
        , used in digital displays, represents Red, Green, and Blue light.
      </p>
      <p>
